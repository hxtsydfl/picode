...
from picode.cli.commands.chat import cmd_chat
from picode.cli.commands.core import cmd_core_start, cmd_core_status, cmd_core_stop
from picode.cli.commands.ping import cmd_ping
from picode.cli.commands.run import cmd_run
from picode.cli.commands.trace import cmd_trace
from picode.cli.commands.version import cmd_version
from picode.core.config import get_config
from picode.core.logging_setup import setup_logging


# CLI 主入口：解析命令行参数并分发到对应子命令
def main() -> None:
    parser = argparse.ArgumentParser(prog="picode", description="Picode CLI")
