...
from picode.core.bus.envelope import HandlerError
from picode.core.bus.events import (
    SessionClosedEvent,
    SessionCreatedEvent,
...
from picode.core.session.model import Session, SessionMode
...
class SessionManager:
    ...
    async def compact(self, sid: str, focus: str = "") -> Any:
        ...
        async with lock:
            from picode.core.bus.commands import SessionCompactResult
