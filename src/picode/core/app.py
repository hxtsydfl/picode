...
import picode
from picode.core.bus.commands import (
    AgentRunCommand,
    AgentRunResult,
...
from picode.core.bus.envelope import EventPushEnvelope
from picode.core.config import PicodeConfig, get_config
from picode.core.events.bus import EventBus
from picode.core.llm.provider import AnthropicProvider
from picode.core.logging_setup import setup_logging
from picode.core.mcp.server import McpServerManager
from picode.core.permissions.manager import PermissionManager
from picode.core.permissions.storage import load_policy_file
from picode.core.runner import AgentRunner
from picode.core.runs import events_file, new_run_id
from picode.core.session import SessionManager, SessionStore
from picode.core.trace.record import TraceRecord
from picode.core.trace.writer import TraceWriter
from picode.core.transport.ipc_broadcaster import IpcEventBroadcaster
from picode.core.transport.socket_server import SocketServer, get_connection_writer
...
class CoreApp:
    def __init__(self) -> None:
        ...
        self._config: PicodeConfig | None = None
    ...
    async def _ping_handler(self, params: dict[str, Any]) -> PongResult:
        ...
        return PongResult(
            server_version=picode.__version__,
    ...
    async def _replay_events(
        ...
        if not path.exists():
            for candidate in Path("~/.picode/sessions").expanduser().glob(
    ...
    async def run(self) -> None:
        ...
        policy_file = Path("~/.picode/policy.toml").expanduser()
        ...
        sessions_root = Path("~/.picode/sessions").expanduser()
        ...
        logger.info("picode-core %s listening addr=%s", picode.__version__, addr)
